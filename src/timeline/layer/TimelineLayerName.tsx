...
const TimelineLayerNameComponent: React.FC<Props> = (props) => {
	const { name } = props;
		...
		<div className={s("wrapper")}>
			<div
				...
				onMouseDown={separateLeftRightMouse({
					left: (e) =>
						timelineHandlers.onLayerNameMouseDown(
							e,
							areaId,
							props.compositionId,
							props.layerId,
...
export const TimelineLayerName = connectActionState(mapState)(TimelineLayerNameComponent);
