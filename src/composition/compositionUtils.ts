...
import { Composition, CompoundProperty, Property, PropertyGroup } from "~/composition/compositionTypes";
...
export const forEachLayerProperty = (
    layerId: string,
    compositionState: CompositionState,
    ...
    const toIterateOver = [...layer.properties];
...
export const reduceCompositionProperties = <T>(
    composition: Composition,
    compositionState: CompositionState,
    fn: (property: Property, acc: T) => T,
    acc: T,
): T => {
    if (!composition) {
